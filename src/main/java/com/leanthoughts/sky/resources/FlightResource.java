...
public class FlightResource extends BaseResource {
    ...
    public String toString() {
        return "com.leanthoughts.sky.resources.FlightResource(id=" + this.id + ", connId=" + this.connId + ", flightDate=" + this.flightDate + ", eta=" + this.eta + ", etd=" + this.etd + ", fromAirport=" + this.fromAirport + ", toAirport=" + this.toAirport + ", operator=" + this.operator + ", sta=" + this.sta + ", std=" + this.std + ", period=" + this.period + ", plane=" + this.plane + ", schedule=" + this.schedule + ")";
    }
}