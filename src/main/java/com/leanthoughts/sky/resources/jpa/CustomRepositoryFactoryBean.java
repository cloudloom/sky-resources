...
public class CustomRepositoryFactoryBean <R extends JpaRepository<T, I>, T, I extends Serializable> extends JpaRepositoryFactoryBean<R, T, I> {
   ...
   private static class CustomRepositoryFactory<T extends BaseAggregate, ID extends Serializable> extends JpaRepositoryFactory {
...
/*       @Override
       ...
       protected <T, ID extends Serializable> SimpleJpaRepository<?, ?> getTargetRepository(RepositoryInformation information, EntityManager entityManager) {
           ...
           if(information.getDomainType().getGenericSuperclass().getTypeName().equals(BaseAggregate.class.getTypeName())) {
